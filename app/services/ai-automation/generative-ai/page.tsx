...
import { ArrowRight, CheckCircle, Users, Code, Layout, Calendar, Shield, Zap, Mail, Phone, Globe, Briefcase, DollarSign, BarChart3, Monitor, ThumbsUp, ChevronDown, Clock, Gift, Shuffle, Headphones, Lightbulb, Palette, Target, Handshake, BadgeDollarSign, PhoneCall } from 'lucide-react';
import { ErrorBoundary } from '@/components/error-boundary';
import { Icon } from '@iconify/react';
import ServicesSection from '@/components/ui/services-section-GenAI';
...
const items = [
  {
    ...
    description: 'Taking 15+ Hours Weekly Teams waste valuable time creating repetitive content instead of focusing on strategy.',
    icon: <Calendar />,
  },
  {
    title: 'Slow Customer Support',
    description: 'Response Times (4-6 Hours) Delayed responses frustrate customers and damage brand reputation.',
    icon: <BarChart3 />,
  },
  {
    title: 'Generic Marketing Messages',
    description: 'With Low Engagement One-size-fits-all content fails to connect with diverse customer segments.',
    icon: <ThumbsUp />,
  },
  {
    title: 'Lack of Personalized Customer Experiences',
    description: 'Generic interactions lead to poor conversion rates and customer churn.',
    icon: <DollarSign />,
  },
];
      ...
      <main className="bg-white text-gray-900">
        ...
        <section className="relative py-20 max-h-[450px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-20 flex flex-col items-center justify-center w-full px-4" style={{ marginTop: '-2rem' }}>
            ...
            >
              Unlock creativity and efficiency with next-generation Generative AI for your business.
            </motion.p>
            <motion.div
            ...
            >
              ...
              >
                <Button size="lg" className="bg-blue-800 text-white rounded-md hover:bg-blue-900 w-full sm:w-auto">Get Started with Generative AI</Button>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 24 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <Button size="lg" variant="outline" className="border border-blue-800 text-blue-800 rounded-md font-semibold hover:bg-blue-800 hover:text-white w-full sm:w-auto">See AI in Action</Button>
              </motion.div>
            </motion.div>
          </div>
          ...
          <div className="relative z-10 w-full max-w-none">
            <div className="text-center pt-16 md:pt-24 pb-10 md:pb-20">
              ...
              <p className="text-sm sm:text-base md:text-lg text-white font-medium max-w-2xl mx-auto">
                Generative AI is transforming the way industries innovate, automate, and create. Explore how our solutions empower businesses across diverse sectors to unlock new possibilities.
              </p>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-8">
              <motion.h2
                ...
                viewport={{ once: true }}
              >
                Addressing Your Generative AI Challenges
