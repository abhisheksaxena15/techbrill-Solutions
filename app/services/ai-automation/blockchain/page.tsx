...
import { Activity, CheckCircle, Scale, GitBranch, User, Settings, Shield, Zap, Truck, Home, Landmark, Briefcase, DollarSign, BarChart3, Monitor, ThumbsUp, ChevronDown, Clock, Gift, Shuffle, Headphones, Lightbulb, Palette, Target, Handshake, BadgeDollarSign, PhoneCall } from 'lucide-react';
import { ErrorBoundary } from '@/components/error-boundary';
import { Icon } from '@iconify/react';
import ServicesSection from '@/components/ui/services-section-Blockchain';
import { cn } from '@/lib/utils';
import ConsultationSection from '@/components/ConsultationSection';
import TechStackSection from '@/components/ui/TechStack-Blockchain';
      ...
      <main className="bg-white text-gray-900">
        ...
        <section className="relative py-20 max-h-[450px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-20 flex flex-col items-center justify-center w-full px-4" style={{ marginTop: '-2rem' }}>
            ...
            >
              Empower your business with secure, transparent, and scalable blockchain solutions for the future of digital trust.
            </motion.p>
            <motion.div
            ...
            >
              ...
              >
                <Button size="lg" className="bg-blue-800 text-white rounded-md hover:bg-blue-900 w-full sm:w-auto">Get Started with Blockchain</Button>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 24 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <Button size="lg" variant="outline" className="border border-blue-800 text-blue-800 rounded-md font-semibold hover:bg-blue-800 hover:text-white w-full sm:w-auto">See Blockchain in Action</Button>
              </motion.div>
            </motion.div>
          </div>
          ...
          <div className="relative z-10 w-full max-w-none">
            <div className="text-center pt-16 md:pt-24 pb-10 md:pb-20">
              ...
              <p className="text-sm sm:text-base md:text-lg text-white font-medium max-w-2xl mx-auto">
                Blockchain technology is revolutionizing industries by enabling secure, transparent, and decentralized solutions. Discover how our blockchain expertise helps organizations across sectors streamline operations, enhance trust, and unlock new business models.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Secure, transparent transactions, cross-border payments, and fraud reduction with blockchain-powered financial solutions.'
                },
                {
                  label: 'Supply Chain & Logistics',
                  icon: <Truck className="w-10 h-10 md:w-12 md:h-12 mx-auto text-blue-600 group-hover:text-white" />,
                  desc: 'End-to-end product traceability, real-time tracking, and reduced counterfeiting through decentralized ledgers.'
                },
                {
                  label: 'Healthcare & Pharma',
                  icon: <Shield className="w-10 h-10 md:w-12 md:h-12 mx-auto text-blue-600 group-hover:text-white" />,
                  desc: 'Secure patient data management, drug traceability, and transparent clinical trials using blockchain.'
                },
                {
                  label: 'Retail & E-Commerce',
                  icon: <Gift className="w-10 h-10 md:w-12 md:h-12 mx-auto text-blue-600 group-hover:text-white" />,
                  desc: 'Authenticity verification, loyalty programs, and seamless payments with blockchain integration.'
                },
                {
                  label: 'Real Estate',
                  icon: <Home className="w-10 h-10 md:w-12 md:h-12 mx-auto text-blue-600 group-hover:text-white" />,
                  desc: 'Tokenized assets, transparent property records, and faster, fraud-resistant transactions.'
                },
                {
                  label: 'Government & Public Sector',
                  icon: <Landmark className="w-10 h-10 md:w-12 md:h-12 mx-auto text-blue-600 group-hover:text-white" />,
                  desc: 'Tamper-proof records, digital identity, and transparent voting systems powered by blockchain.'
                },
                {
                  label: 'Energy & Utilities',
                  icon: <Zap className="w-10 h-10 md:w-12 md:h-12 mx-auto text-blue-600 group-hover:text-white" />,
                  desc: 'Peer-to-peer energy trading, grid management, and carbon credit tracking on decentralized platforms.'
                },
                {
                  label: 'Legal & Professional Services',
                  icon: <Briefcase className="w-10 h-10 md:w-12 md:h-12 mx-auto text-blue-600 group-hover:text-white" />,
                  desc: 'Smart contracts, secure document management, and automated compliance for legal professionals.'
                },
              ].map((item, idx) => (
                <div
                  key={item.label}
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-8">
              <motion.h2
                ...
                viewport={{ once: true }}
              >
                Overcoming Key Blockchain Challenges
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                We understand the obstacles you face and have solutions ready for every blockchain challenge.
              </motion.p>
            </div>
