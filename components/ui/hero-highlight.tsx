...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[40rem] w-full items-center justify-center bg-gray-50 dark:bg-black",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-[#3b82f6] via-[#6366f1] to-[#8b5cf6] px-1 pb-1 dark:from-[#6366f1] dark:to-[#8b5cf6]`,
        className,
      )}
    >
      {children}
